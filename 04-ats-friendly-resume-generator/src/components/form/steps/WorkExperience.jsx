...
import { SortableContext, sortableKeyboardCoordinates, arrayMove, verticalListSortingStrategy, useSortable } from '@dnd-kit/sortable'
...
function SortableBullet({ id, value, placeholder, showRemove, onUpdate, onRemove }) {
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex flex-col gap-0.5">
      <div className="flex gap-2 items-start">
        ...
        />
        {showRemove && (
          <Button variant="danger" size="icon" onClick={onRemove} title="Remove bullet">
            ×
          </Button>
        )}
      </div>
